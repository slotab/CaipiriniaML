...
data_yaml = "/Users/bslota/IdeaProjects/summer-challenge-ia/out/yolo/datasets/dataset.yaml"  # Le fichier .yaml qui décrit le dataset

# Entraîner le modèle
model.train(data=data_yaml, epochs=50, imgsz=640, batch=16, name="yolov8_caipirinia_model")
